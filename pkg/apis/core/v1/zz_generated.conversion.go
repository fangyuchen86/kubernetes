...
func autoConvert_v1_ProbeResult_To_core_ProbeResult(in *v1.ProbeResult, out *core.ProbeResult, s conversion.Scope) error {
	out.RestartCount = in.RestartCount
	out.LivenessProbe = core.CustomProbeResult(in.LivenessProbe)
	out.StartupProbe = core.CustomProbeResult(in.StartupProbe)
	out.ReadinessProbe = core.CustomProbeResult(in.ReadinessProbe)
	return nil
}
...
func autoConvert_core_ProbeResult_To_v1_ProbeResult(in *core.ProbeResult, out *v1.ProbeResult, s conversion.Scope) error {
	out.RestartCount = in.RestartCount
	out.LivenessProbe = v1.CustomProbeResult(in.LivenessProbe)
	out.StartupProbe = v1.CustomProbeResult(in.StartupProbe)
	out.ReadinessProbe = v1.CustomProbeResult(in.ReadinessProbe)
	return nil
}
